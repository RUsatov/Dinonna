            ...
            <div class="post_inner">
              <div class="post_header row items-center q-mb-sm">
                ...
                <div class="post_status">
                  <q-icon v-if="post.status === 'positive'" color="green" name="far fa-smile" size="24px" />
              ...
              <div class="post_body bg-white row q-pa-md shadow-2">
                <div class="post_img self-center">
                  <q-img v-if="post.img" :ratio="1" style="max-width: 150px; height: 100px;" :src="post.img" spinner-color="primary" />
                  <q-img v-else :ratio="16/9" style="max-width: 150px; height: 100px;" contain src="./statics/img/logo.png" spinner-color="primary" />
                </div>
      ...
      feeds: [
        {
          ...
          status: 'negative',
          img: 'https://ru.foodsoul.pro/uploads/branches/332/images/feedback/4c008d7cc53fc8099b83fcb7a782cbdc.jpg',
          text: 'Будем надеятся, что не аккуратность доставки не отразится на вкусе.'
        },
        {
          id: 2,
          name: '',
          ...
          status: 'positive',
          img: '',
          text: 'Пицца агонь, только жувачку не положили в этот раз！Вот весь в печали'
        },
        {
          id: 3,
          name: '',
          ...
          status: 'positive',
          img: '',
          text: 'Все отлично, жаль, что в последнее время перестали класть жвачку.'
        },
      ]
    }
  },
